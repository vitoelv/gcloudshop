...
public class ArticleListPanel extends ContentWidget implements URLConstants{
	...
	protected void onRender(Element parent,int index){
		...
		articleCat.setDisplayField(IArticleCat.CAT_NAME);
		articleCat.setValueField(IArticleCat.PK_ID);
...
//		wantedFields.add(ArticleForm.ADD_TIME);
		...
		columns.add(new CheckColumnConfig(ArticleForm.IS_OPEN, Resources.constants.Article_colisOpen(), 150));
		ColumnConfig coltime = new ColumnConfig(ArticleForm.ADD_TIME, Resources.constants.Article_coladdTime(), 160);
		columns.add(coltime);
		...
		act.setAction("viewArticle($pkId)");
