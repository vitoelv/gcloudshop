...
public class PaymentMetaList extends ContentWidget {
    ...
    private native void initJS(PaymentMetaList me) /*-{
       $wnd.installPayment = function (code) {
           me.@com.jcommerce.gwt.client.panels.PaymentMetaList::installPayment(Ljava/lang/String;)(code);
       };
       $wnd.editPayment = function (id) {
           me.@com.jcommerce.gwt.client.panels.PaymentMetaList::editPayment(I)(id);
       };
       $wnd.uninstallPayment = function (id) {
           me.@com.jcommerce.gwt.client.panels.PaymentMetaList::uninstallPayment(I)(id);
       };
       }-*/;
