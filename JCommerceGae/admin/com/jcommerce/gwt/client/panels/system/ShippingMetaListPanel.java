...
//        columns.add(new ColumnConfig(ShippingConfigMetaForm.PK_ID, Resources.constants
//                .ShippingMetaList_ID(), 50));
        ColumnConfig col = new ColumnConfig(ShippingConfigMetaForm.SHIPPING_NAME, Resources.constants
...
//        panel.setBottomComponent(toolBar);
    ...
    public void refresh() {
        System.out.println("----- refresh ShippingMetaList---");
        loader.load();
        System.out.println("----- finish ShippingMetaList---");
    }
