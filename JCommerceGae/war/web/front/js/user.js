...
function is_registered( username )
{
    ...
    Ajax.call( 'user.action?act=is_registered', 'username=' + username, registed_callback , 'GET', 'TEXT', true, true );
}
...
function checkEmail(email)
{
  ...
  Ajax.call( 'user.action?act=check_email', 'email=' + email, check_email_callback , 'GET', 'TEXT', true, true );
}
...
{
  Ajax.call('user.action?act=return_to_cart', 'order_id=' + orderId, returnToCartResponse, 'POST', 'JSON');
}
