...
<div class="block clearfix">
  ...
  <div class="AreaR">
   ...
   <div class="box">
   <div class="box_1">
    <h3><span>${lang.gbGoodsName}</span></h3>
    <div class="boxCenterList">
      <#if ( gbList??  ) >
      <#list gbList as groupBuy>
      <ul class="group clearfix">
      <li style="margin-right:8px; text-align:center;">
      <a href="${groupBuy.url}"><img src="${groupBuy.goodsThumb}" border="0" alt="${groupBuy.goodsName?html}" style="vertical-align: middle" /></a>
      </li>
      <li style="width:555px; line-height:23px;">
      ${lang.gbGoodsName}<a href="${groupBuy.url}" class="f5">${groupBuy.goodsName?html}</a><br />
      ...
      <#else>
       <span style="margin:2px 10px; font-size:14px; line-height:36px;">${lang.groupGoodsEmpty}</span>
      </#if>
    </div>
   </div>
  </div>
