...
public class AliPay extends BasePaymentMetaPlugin implements IPaymentMetaPlugin {
    ...
    static {
        ...
        defaultPaymentConfigMeta.setPayCode("alyPay");
        defaultPaymentConfigMeta.setPayName("支付宝");
        defaultPaymentConfigMeta.setPayFee("10");
...
&sign_type=MD5  
    ...
    public String getCode(OrderInfo order, Payment payment , List<OrderGoods> orderGoods) { 
        ...
        buf.append("&out_trade_no=").append(
                order.getOrderSn() + "_" + (new Date().getTime()));
        ...
        buf.append("&subject=").append(order.getOrderSn());
