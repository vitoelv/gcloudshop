...
//    	return btnAdd;
	...
	private void generateDynaFields() {
        ...
        tb.setName(PaymentConfigMetaForm.PAY_NAME);
        tb.setValue(result.getPayName());
        tb.setOriginalValue(result.getPayName());
        formPanel.add(tb);
        
        TextArea ta = new TextArea();
        ta.setName(PaymentConfigMetaForm.PAY_DESC);
        ...
        tb.setName(PaymentConfigMetaForm.PAY_FEE);
