	...
	protected void setupPanelLayout() {
		...
		fListArticleCat.addSelectionChangedListener(new SelectionChangedListener<BeanObject>(){
			...
			public void selectionChanged(SelectionChangedEvent<BeanObject> se) {
				...
				if(selectedCat.getString(ArticleCatForm.CAT_TYPE).equals("4")){
					catType.setValue("5");
				}
				else if(selectedCat.getString(ArticleCatForm.CAT_TYPE).equals("1")){
					catType.setValue("1");
				}
				else if(selectedCat.getString(ArticleCatForm.CAT_TYPE).equals("2")){
