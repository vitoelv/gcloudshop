...
public class ChinaBank extends BasePaymentMetaPlugin implements IPaymentMetaPlugin {
    ...
    static {
        ...
        defaultPaymentConfigMeta.setPayCode("ChinaBank");
        defaultPaymentConfigMeta.setPayName("网银在线");
        defaultPaymentConfigMeta.setPayFee("2.5%");
...
<input type=submit value='立即使用网银在线支付'>
    ...
    public String getCode(OrderInfo order, Payment payment , List<OrderGoods> orderGoods) {
        ...
        String data_orderid = order.getOrderSn();
